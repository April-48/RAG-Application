...
A model selector in the UI would allow users to switch LLM models at runtime without changing environment variables — useful once multiple models are available at different price and quality points.
